...
-- Fix all RPC functions with correct column names and remove all limits

-- Fix the fetch_darwin_projections function with correct column references
...
-- Fix the fetch_pacing_data function with correct column mapping
